-- D-160 Evidence Mesh — dedicated Production D1 metadata.
-- Raw bytes live only in the private EVIDENCE_PRODUCTION_RAW R2 bucket and are encrypted
-- before storage. This migration is environment-isolated and applies only through the explicit Production release gate.
