...
const flags={HEARTH_HOUSE_WORLD:1,HEARTHSIDE:1,HEARTHSIDE_DESIGN:1,HEARTHSIDE_VAULT:1,HEARTHSIDE_WORKSPACE:0,HEARTHSIDE_GUESTS:0,HEARTHSIDE_AR:0,HEARTHSIDE_EXPORTS:0,LEDGER_SYNC_V2:1,LEDGER_SYNC_LOCAL_AUTH:1,PRODUCTION_CONTINUITY:0,HERCULES_PLAY:1,HERCULES_DRESSING_ROOM:1,HERCULES_WORKSPACE:0};
const banner='<aside id="whole-house-review-label" style="position:relative;z-index:100000;background:#283f36;color:#fff6d7;padding:7px 14px;font:12px system-ui;text-align:center">Fictional local house · real app commands · no hosted services <a style="color:inherit;margin-left:15px" href="/__review?member=MEM-001">Alex</a> <a style="color:inherit;margin-left:10px" href="/__review?member=MEM-002">Sam</a></aside>';
