...
{query.has('ledge')?<><p>Home · fictional component proof</p><FundLedge household={h} today={today} view={room} memberId="MEM-002" busy={false} scenarioSource={source} onKitchen={()=>{throw Error('Unexpected financial action')}} onOpenAccount={()=>{}} onOpen={()=>{}} /></>:<Ask household={h} memberId="MEM-002" today={today} busy={false} scenarioSource={source} presentation={query.has('desk')?'desk':'phone'} onMove={()=>{throw Error('Unexpected financial action')}} />}
