...
# Roadmaps and artifacts

- `docs/HEARTH_ROADMAP.md`, living strategy/architecture/decisions, and current code are authority in the order defined by `AGENTS.md`.
- `docs/CLAUDE_*.md` files are assignment records, not automatic current plans.
