...
- Development Supabase provides cloud continuity envelopes and member-personal rows; PGlite remains each device's validated books engine. Development data is disposable/open through 2026-09-30. Production remains off-limits until Auth plus restrictive RLS exist.
