...
- Current code candidate: `v0.0.31` on `issue-2-add-shift-e2e`; the repository suite passes, but the high-risk independent reviews, development-only source approval, and live-Sheet verification remain pending
