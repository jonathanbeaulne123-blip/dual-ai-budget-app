...
export function VillageHUD({place,travelling,onVisit,onArrange,onView,onWander,onJourney,avatar,onAvatar}:{place:HarbourPlaceId;travelling:HarbourPlaceId|null;onVisit:(id:HarbourPlaceId,instant?:boolean)=>void;onArrange?:()=>void;onView:()=>void;onWander?:(id:HarbourWanderId)=>void;onJourney?:()=>void;avatar?:PlayableAvatar|null;onAvatar?:(avatar:PlayableAvatar)=>void}){
