...
export function VillageHUD({appearanceRequest,place,travelling,onVisit,onArrange,onView,onWander,onJourney,avatar,avatarStatus,onAvatar,presence}:{appearanceRequest?:number;place:HarbourPlaceId;travelling:HarbourPlaceId|null;onVisit:(id:HarbourPlaceId,instant?:boolean)=>void;onArrange?:()=>void;onView:()=>void;onWander?:(id:HarbourWanderId)=>void;onJourney?:()=>void;avatar?:PlayableAvatar|null;avatarStatus?:'idle'|'loading'|'ready'|'error';onAvatar?:(avatar:PlayableAvatar)=>void;presence?:ReactNode}){
