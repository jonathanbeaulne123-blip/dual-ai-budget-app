...
export type SkaterLook = {
  ...
  setEmote(id: EmoteId | null, seconds: number): void;
...
export function createSkaterLook(opts: SkaterLookOptions): SkaterLook {
  ...
  let emote: EmoteId | null = null, emoteAt = 0;
  ...
  return {
    ...
    update(p, events, dt, reduced) {
      ...
      motion.emote = emote; motion.emoteAt = emoteAt;
    ...
    setEmote(id, seconds) { emote = id; emoteAt = seconds; },
