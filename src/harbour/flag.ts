...
export type HarbourPlaceId = "court" | "tower" | "cellar" | "glasshouse" | "kitchen" | "boathouse" | "library" | "cottage";
...
export const HARBOUR_ROOMS: Readonly<Partial<Record<HouseRoom, Readonly<Partial<Record<HouseLevel, HarbourPlaceId>>>>>> = Object.freeze({
  ...
  // Hercules's Cottage is its middle; the Kiln keeps the house's own studio
  // above and below until it is built.
  making: Object.freeze({ middle: "cottage" }),
});
...
export const HARBOUR_PLACE_NAMES: Readonly<Record<HarbourPlaceId, string>> = Object.freeze({
  ...
  kitchen: "the Kitchen", boathouse: "the Boathouse", library: "the Library", cottage: "the Cottage",
});
...
export const HARBOUR_PLACE_LEVELS: Readonly<Record<HarbourPlaceId, HouseLevel>> = Object.freeze({
  ...
  kitchen: "middle", boathouse: "middle", library: "middle", cottage: "middle",
});
...
export const HARBOUR_PLACE_ROOMS: Readonly<Record<HarbourPlaceId, HouseRoom>> = Object.freeze({
  ...
  kitchen: "kitchen-table", boathouse: "together", library: "study", cottage: "making",
});
