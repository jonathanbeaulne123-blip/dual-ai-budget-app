...
export default function HorizonWorld(props:HarbourWorldProps){
  ...
  function toggleSound(){
    const next=!soundOn;audio.current?.dispose();audio.current=null;
    if(next){updateComfort({sound:true});try{audio.current=createWorldAmbience();}catch{audio.current=null;}}
