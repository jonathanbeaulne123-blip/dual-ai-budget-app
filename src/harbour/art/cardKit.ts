/**
 * The painted-card kit shared by Tideline Skate Club v2 and Hearth Mountain.
 *
...
import { planeAt, type Plane } from '../skate/world/features.ts';
import { frameToWorld, type Frame } from '../skate/world/profiles.ts';
