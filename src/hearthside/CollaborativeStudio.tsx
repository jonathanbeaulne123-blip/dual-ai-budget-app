...
function StudioSession({audience,returnPath,onSelection,nestSource,initialSculpt,household,memberId,bankId,initialDesignId,initialPieceId,initialTab='shape',writesEnabled=HEARTHSIDE_FLAGS.collaborativeDesign,onKeep,onFundingIntent,acceptedReceipt,wardrobe,handoff}:CollaborativeStudioProps){
