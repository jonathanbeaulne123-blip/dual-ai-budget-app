...
export function projectContext(project: WorkspaceProject): string {
  ...
  return JSON.stringify({ experience, goal:project.goal.length<=4000?project.goal:{retrieve:'context',length:project.goal.length}, completionCriteria:project.completionCriteria,
