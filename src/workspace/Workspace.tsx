...
export function HerculesWorkspaceRoom(props: WorkspaceProps) {
  const key=JSON.stringify([props.identity,props.environment,props.householdId,props.memberId,props.hearthside?.experience.id??null]);
...
function HerculesWorkspaceScope(props:WorkspaceProps){
  ...
  const scopeKey = props.hearthside?'hearthside-workspace:'+JSON.stringify([props.identity,props.environment,props.householdId,props.memberId,props.hearthside.experience.id]):`hercules-workspace:${props.identity}:${props.environment}:${props.householdId}:${props.memberId}`;
  const experienceProjectId=props.hearthside?workspaceExperienceProjectId(props.hearthside.scope,props.hearthside.experience.id):null;
  ...
  const [experienceShare,setExperienceShare]=useState<ArtifactVersion|null>(()=>{
    ...
    const saved=readEntryLocal<{review:ExperienceArtifactReview;pending:boolean}>(workspaceExperienceKey(props.hearthside.scope,props.hearthside.experience.id)+':publication');
