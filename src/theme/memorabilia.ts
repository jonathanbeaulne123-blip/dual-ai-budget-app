...
export type MemorabiliaAsset = {
  ...
  crop: string; phone: string; desktop: string; status: "awaiting-original" | "prepared" | "reference-received";
};
export const MEMORABILIA: MemorabiliaAsset[] = [
  { id: "jonathan-bracelet", scenes: ["lover", "showgirl"], source: "Jonathan’s actual bracelet photograph", src: null, width: 840, height: 410, alt: "Jonathan’s friendship bracelet", placement: "reference", crop: "Isolate bead colours, letter spacing and charms for the authored bracelet pair", phone: "Reference for the 130px paired illustration", desktop: "Reference for the 260px paired illustration", status: "awaiting-original" },
  { id: "bianca-bracelet", scenes: ["lover", "showgirl"], source: "Bianca’s actual bracelet photograph", src: null, width: 840, height: 410, alt: "Bianca’s friendship bracelet", placement: "reference", crop: "Isolate bead colours, letter spacing and charms for the authored bracelet pair", phone: "Reference for the 130px paired illustration", desktop: "Reference for the 260px paired illustration", status: "awaiting-original" },
  { id: "bracelet-pair", scenes: ["lover", "showgirl"], source: "Prepared original artwork based on the two supplied bracelet photographs", src: null, width: 840, height: 498, alt: "Jonathan and Bianca’s friendship bracelets, together", placement: "bracelets", crop: "Transparent background; preserve both complete names", phone: "130×77px; preserve both names and the sample composition", desktop: "Scale the same 840×498 crop within the authored bracelet frame", status: "awaiting-original" },
  { id: "concert-dress", scenes: ["showgirl"], source: "User-supplied rose-pink sequin dress reference; original stays private", src: null, width: 480, height: 640, alt: "The sparkle and fabric of Bianca’s concert dress", placement: "reference", crop: "Fabric detail only; preserve real colour and sparkle character", phone: "Accent reference for satin/sequin art", desktop: "Accent reference for satin/sequin art", status: "reference-received" },
...
export const missingMemorabilia = () => MEMORABILIA.filter(asset => asset.status === "awaiting-original");

/** Jonathan approved fictional stand-ins until originals are available. These never mark an asset prepared. */
export const MEMORABILIA_PLACEHOLDERS: Record<string, string> = {
  "concert-photo": "/theme-art/placeholder-concert.svg",
  "concert-dress": "/theme-art/placeholder-dress.svg",
};
