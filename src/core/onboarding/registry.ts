...
export const ONBOARDING_REGISTRY: readonly OnboardingChapter[] = [
  ...
  householdChapter({
    id: "ch-04-accounts", order: 4, sitting: 2, target: { tab: "ledger" }, conductor: "partner", approval: "none",
    skip: "household-required", timeBudgetSeconds: 360, pausePoints: ["after-shared-accounts"], actions: ["navigate", "continue"], dependsOn: ["ch-03-charter"],
  }),
  householdChapter({
  ...
  householdChapter({
    id: "ch-06-fund", order: 6, sitting: 2, target: { tab: "ledger" }, conductor: "partner", approval: "joint",
  ...
  householdChapter({
    ...
    skip: "household-required", timeBudgetSeconds: 300, pausePoints: ["before-approval"], actions: ["navigate", "edit", "submit", "approve", "continue"], dependsOn: ["ch-10-estimates"],
  }),
  householdChapter({
