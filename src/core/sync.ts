...
export function ensureHouseholdShape(household: Household): Household {
  ...
  return {
    ...
    fundModelRows:shapeFundModelRows(household.fundModelRows),
...
export function splitForSync(household: Household, memberId: string): { shared: SharedEnvelope; personal: PersonalEnvelope } {
  ...
  const shared: SharedEnvelope = {
    ...
    fundModelRows:shapeFundModelRows(shaped.fundModelRows).filter(r=>r.visibility==='household'),
  ...
  const personal: PersonalEnvelope = {
    ...
    fundModelRows:personalFundRows(shapeFundModelRows(shaped.fundModelRows),memberId),
...
export function personalReplicaForMember(household: Household, memberId: string): PersonalEnvelope {
  ...
  return {
    ...
    fundModelRows:personalFundRows(shapeFundModelRows(personal.fundModelRows),memberId),
...
export function personalEnvelopeFromPayload(
  ...
  return {
    ...
    fundModelRows:personalFundRows(shapeFundModelRows(row.fundModelRows),memberId),
...
export function overlayPersonalReplica(
  ...
  return ensureHouseholdShape({
    ...
    fundModelRows:mergeFundModelRows(shapeFundModelRows(household.fundModelRows).filter(r=>!(r.visibility==='personal'&&'setBy' in r&&r.setBy===memberId)),personal.fundModelRows),
...
export function assembleHousehold(
  ...
  return ensureHouseholdShape({
    ...
    fundModelRows:mergeFundModelRows(shapeFundModelRows(shared.fundModelRows).filter(r=>r.visibility==='household'),personal?personalFundRows(personal.fundModelRows,personal.memberId):[]),
...
export function mergeShared(server: SharedEnvelope, client: SharedEnvelope): SharedEnvelope {
  ...
  return {
    ...
    fundModelRows:mergeFundModelRows(server.fundModelRows,client.fundModelRows).filter(r=>r.visibility==='household'),
...
export function mergePersonal(server: PersonalEnvelope, client: PersonalEnvelope): PersonalEnvelope {
  ...
  return {
    ...
    fundModelRows:personalFundRows(mergeFundModelRows(server.fundModelRows,client.fundModelRows),memberId),
