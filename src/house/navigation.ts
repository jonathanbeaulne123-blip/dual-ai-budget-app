...
export const HOUSE_PLACES = {
  ...
  study: {above: {title:"Glasshouse · steps", subtitle:"A place to pick up where you left off", target:"planner"}, middle: {title:"The Standing Book", subtitle:"Every figure has a source. Every page has a place.", target:"books"}, below: {title:"Calendar", subtitle:"The same intentions, seen through time", target:"calendar"}},
...
export const TARGET_NAMES: Record<string,string> = {queen:"The Fund bank", "loft-banks":"Open Kitty Banks", "cellar-bills":"Read the bill jars", books:"Open the Standing Book", planner:"Open the Glasshouse steps", calendar:"Unfold the Calendar", journey:"Step into Journey", conversation:"Open the conversation folio", "plan-studio":"Open the kitchen table", wishes:"Tend a wish", pottery:"The Kiln", memories:"Open a memory", letters:"Open the writing desk", projector:"Choose three memories", hercules:"Talk with Hercules", encounters:"Spend a moment together", wardrobe:"Open the dressing room", shift:"Open Shifts",
