        ...
        onOpenWorkspace={workspaceEnabled ? () => { setWorkspaceProjectId(null);setWorkspaceExperienceSelection(null); goTab("hercules"); } : undefined}
            ...
            />
              ...
              return view === "household" ? (
                ...
                <OurPathWorld key={ledgerRenderScopeKey} household={household} memberId={actorId} today={today} interpretationGate={sceneInterpretationGate} busy={busy} onCommand={runKitchen} onEnterHarbour={() => navigateHouseSurface({householdId:household.householdId,scope:"household",room:"home",level:"middle",village:{place:"court"}})} onOpenFund={() => goTab("ledger")}
