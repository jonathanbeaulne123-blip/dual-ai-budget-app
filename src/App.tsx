...
export function App() {
  ...
  usePublishBarBadges(HARBOUR_ENABLED && sceneInterpretationGate.current && activeBooksGate.ready && household && session ? { household, memberId: session.memberId, scope: view, today } : null);
