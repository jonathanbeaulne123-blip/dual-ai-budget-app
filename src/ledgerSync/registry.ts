...
register(
  `adoptExistingOnboardingEvidence recordChapterAcknowledgement recordObservedChapterCompletion skipPersonalStep skipChapterFourPersonalAccounts setOnboardingOffersMuted recordPersonalModuleOffer declinePersonalModuleOffer completePersonalModule submitOnboardingCategories mergeOnboardingCategories submitOnboardingEstimates approveOnboardingProposal approveOnboardingReady completeHouseholdOnboarding setLandingSurface setFundRailSlot resetFundRail setGlanceAccount setHerculesProPermissions setFundCardAccount savePlanDraft createPlanScenario lockPersonalPlan savePlanLearningProgress setPlanCoachingIntensity updatePlanNudgeState savePlanReflection proposeHouseholdPlan adoptLegacyHouseholdPlan acknowledgeHouseholdPlan proposePlanBridge withdrawPlanBridge postShift postWorkShift refreshSevenShiftsSchedule refreshShiftEnvelopesFromEvidence confirmShiftEnvelopeOutcome appendShiftBibleWeather retireResolvedShiftEnvelope reconcileWorkWeekFromEvidence recordEarningCadence postWorkShiftWithAttendanceReview approveHouseholdFundConfiguration adoptFirstBudget`,
  ["createdBy", "memberId"],
);
register(
