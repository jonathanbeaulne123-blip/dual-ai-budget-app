...
describe("the world-presence lane in the browser", () => {
  ...
  it("keeps a peer's track, and drops the peer after seconds of silence", async () => {
    ...
    socket.deliver({ type: "world-peer", memberId: "MEM-002", deviceId: "MEM-002:DEVICE-b", placeId: "court", seenAt: h.now(), world:"hearth-mountain-2", y:51, x: 1, z: 2, yaw: 0.4, moving: true });
    h.tick(WORLD_STEP_MS);
    socket.deliver({ type: "world-peer", memberId: "MEM-002", deviceId: "MEM-002:DEVICE-b", placeId: "court", seenAt: h.now(), world:"hearth-mountain-2", y:51, x: 2, z: 2, yaw: 0.4, moving: true });
