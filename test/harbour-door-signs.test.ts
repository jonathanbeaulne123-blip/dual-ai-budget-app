...
import { buildHarbourReading, EMPTY_CELLAR_READING, EMPTY_CISTERN_READING, EMPTY_GLASSHOUSE_READING, EMPTY_TOWER_READING, type HarbourReading } from "../src/harbour/data/reading.ts";
