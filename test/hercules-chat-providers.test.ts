...
function chatRequest(message = "Did the synthetic marker post?", ip = "203.0.113.91") {
...
describe("Hercules in-app chat provider chain", () => {
  ...
  it("uses Groq after empty Gemini output and keeps the completion budget", async () => {
