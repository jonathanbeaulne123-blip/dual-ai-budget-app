...
afterEach(async () => { vi.unstubAllEnvs(); await act(async () => root.unmount()); host.remove(); document.documentElement.classList.remove("path-world-fullscreen", "path-world-settled"); });
