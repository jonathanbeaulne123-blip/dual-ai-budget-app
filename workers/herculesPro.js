...
const TOOL_CATALOG = [
  ...
  ["list_shifts", "Page through posted shifts with sales, covers, staffing, tip%, and event tags. Prefer tip_oracle aggregates first."],
...
const TOOL_PROPERTIES = {
  ...
  tippedOnly: { type: "boolean" },
  customersServed: { type: "integer", minimum: 0, maximum: 5000 },
  staffingCount: { type: "integer", minimum: 1, maximum: 200 },
...
const TOOL_PROPERTY_NAMES = {
  ...
  find_transactions: ["view", "period", "from", "to", "member", "account", "category", "merchant", "minimumAmountCents", "maximumAmountCents", "limit", "cursor"],
  ...
  trial_balance: ["view"],
  general_ledger: ["view", "period", "from", "to", "member", "account", "limit", "cursor"],
  account_activity: ["view", "account", "period", "from", "to", "limit", "cursor"],
  ...
  activity_since_reconciliation: ["view", "account", "limit", "cursor"],
  uncategorized_activity: ["view", "period", "from", "to", "limit", "cursor"],
  ...
  audit_trail: ["view", "limit", "cursor"],
  list_shifts: ["view", "period", "from", "to", "member", "job", "eventTag", "tippedOnly", "limit", "cursor"],
  ...
  shift_outlook: ["view", "member", "date", "hours", "meal", "weatherGlass", "eventTag", "salesCents", "customersServed", "staffingCount"],
  tip_schedule_sim: ["view", "member", "days", "weatherGlass", "eventTag"],
