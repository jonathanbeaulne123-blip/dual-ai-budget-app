...
export async function importLegacy(
  ...
  const scopedFields=new Set(['kittyNestDesigns','nativeEvents','tasks','taskLists','members','accounts','transactions','shifts','goals','goalContributions','goalPurchases','activity','tombstones','companionProfile', 'fundPrivate','herculesProPermissions','sevenShiftsSchedules','coworkers','coworkerAttendance','coworkerSchedules','shiftEnvelopes','shiftBibles']);
