...
{id:"resumes",group:"Job kit",label:"15–20 printed resume copies"},
...
{id:"travel",start:"08:20",end:"09:20",type:"field",label:"Route + Print",title:"Travel into Toronto + Staples print stop",desc:"Use the Route Portal to choose the first viable cluster, then stop at Staples before the first A-GAME restaurant. Print tailored cover letters for the A-GAME / STRONG shortlist plus extra resume copies; keep digital backups on phone/laptop.",action:"staples"},
...
function actions(block){if(!block.action)return"";if(block.action==="portal")return `<a class="mini-link" href="${preview("map.html")}">Open Route Portal ↗</a>`;if(block.action==="district0")return `<a class="mini-link" href="${preview("map.html",{focusDistrict:0})}">Open District 1 ↗</a>`;if(block.action==="staples")return `<a class="mini-link" target="_blank" rel="noopener noreferrer" href="https://www.google.com/maps/search/?api=1&query=Staples">Find Staples ↗</a><a class="mini-link" href="${preview("map.html")}">Open Route Portal ↗</a>`;return `<a class="mini-link" href="${preview("index.html")}">Open checklist ↗</a>`}
