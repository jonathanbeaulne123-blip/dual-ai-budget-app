...
window.CLAUDE_DISCOVERIES = [
  ...
  {id:'C13',name:'Ceci Bar · Oliver & Bonacini',address:'33 Yonge St (4 Front St E), Toronto',cluster:'Union / Financial District',tier:'STRONG',
   why:'Full-time bartender at O&B’s Italian aperitivo bar three minutes from Union; same SmartRecruiters profile as the other O&B roles.',
   transit:'Union → 3 minutes on foot.',
   hours:'Afternoon/evening aperitivo hours not verified; online first.',site:'https://www.oliverbonacini.com/',
...
(function(root){
  ...
  if(A){
    ...
    A.rows=[
      ...
      {id:'C13',wave:'Next wave',name:'Ceci Bar · O&B',role:'Bartender · FT',why:'Full-time O&B bar three minutes from Union.',gate:'O&B group alternative; two years bartending.',group:'Oliver & Bonacini',urgency:'live'},
      ...
      {id:'C17',wave:'Next wave',name:'IRENE Corus Quay',role:'Bartender · FT',why:'Full-time waterfront bar, four days/week, Immediate Start.',gate:'23-day-old advert; the degree line looks like a form default — ask.',group:'FAB Restaurants',urgency:'live'},
      ...
      {id:'C14',wave:'Reserve',name:'MLSE · Hot Stove Club',role:'Supervisor · premium restaurants',why:'C$26/hour attached to Union.',gate:'Workday page did not confirm open/closed — reopen first.',group:'MLSE',urgency:'live'},
      {id:'C15',wave:'Reserve',name:'360 Restaurant · CN Tower',role:'Bartender · PT service bar',why:'C$23.56 with pension and benefits.',gate:'Wine/spirits certification listed as required; application board not verified here.',group:'CN Tower',urgency:'live'},
      ...
      {id:'C11',wave:'Later',name:'Simona',role:'Food Service Supervisor (bar lead)',why:'Direct bar-lead match on the waterfront.',gate:'Start October 5.',group:'FAB Restaurants',urgency:'later'},
      {id:'A02',wave:'Later',name:'Arianna at Harbour Sixty',role:'Server / FOH',why:'Live all-FOH recruitment.',gate:'Start September 28; 3+ years upscale preferred; tip figures are employer claims.',group:'Harbour Sixty',urgency:'later'},
    ...
    A.weekPlan=[
      ...
      ['Tue 22 · Port Credit','Closest cluster, likeliest offer','Habitat 14:00, Mercatto by 14:45 (MiWay 23 from Clarkson GO stops at Brightwater — free after a GO tap — or a 25-minute walk from Port Credit GO). Snug Harbour is an optional walk-in on the way back.'],
      ['Wed 23 · Oakville (optional)','Only if Aidan replies or time allows','Ce Soir’s new bartender/server roles first; bar Su in Kerr Village is a 20-minute walk from Oakville GO. Tabule is online-only now. Wednesday noon check: no interviews yet → review résumé clarity, missing portal steps and role choice; activate Reserve.'],
    ...
    A.claudeNote='Board reordered by Claude on September 19 after live rechecks of 48 postings. First wave = eight applications tonight across eight employer groups. Salaried management roles (Ce Soir coordinator, Tabule) moved to stretch/reserve because their live requirements exceed what the résumé documents.';
  }
  ...
  if(P){
    ...
    P.sprees=[
      {id:'union-core',name:'Union core walk',date:'2026-09-21',start:'14:00',days:[1,2,3,4,5],preferred:'Monday · after the weekend applications',station:'Union Station, Toronto',
       entry:'Clarkson 13:08 → Union 13:45 (37 min). Chotto Matte is 3 minutes away inside Brookfield Place; Bar Filo 8 minutes north; then the 504 King streetcar or a 25-minute walk west to La Plume. Fairmont, Sheraton, National Club and CIBC Square are online-only — pass them, do not walk in. Return from Union on the :17/:47 trains.',
       why:'Three rooms with live roles on one walking line from Union, all before the 3pm happy hours. Applications go in first; the loop is to be seen once, briefly, where a quiet window exists.',
       stops:[
         {id:'C06',walk:0,window:['14:00','14:50'],hours:'Mon–Thu 11:30am–11pm; happy hour 3–6pm.',url:'https://chotto-matte.com/toronto/contact/',note:'Apply online first. Ask for the bar manager only if the room is quiet after lunch; leave before happy hour.'},
         ...
         {id:'N30',walk:25,window:['14:30','16:00'],hours:'Bar open through the afternoon; lunch ends 2:30pm; dinner from 5pm.',url:'https://www.laplumebrasserie.com/contact/',note:'Exact server application first. Public bar access continues between services.'},
         {id:'N03',walk:10,window:['14:00','14:30'],hours:'11:30am–1am; happy hour 2–5pm daily.',url:'https://www.cactusclubcafe.com/location/first-canadian-place/',note:'Optional and off by default: the 2–5pm happy hour makes afternoon introductions awkward.'}
       ],omitted:['N03'],later:'Ceci Bar (Front & Yonge) and Strella Strella (King W) are online-first; add only if a contact suggests a time.'},
      {id:'port-credit',name:'Port Credit',date:'2026-09-22',start:'14:00',days:[2,3,4],preferred:'Tuesday',station:'Port Credit GO, Mississauga',
       ...
       stops:[
         {id:'N01',walk:0,window:['14:00','14:40'],hours:'Tue 11am–3pm; Wed–Thu 11am–3pm, dinner from 5:30pm.',url:'https://www.habitatsocial.ca/',note:'Bartender application first. A late-lunch visit may meet a different team from the evening bar.'},
         {id:'N12',walk:25,window:['14:00','16:00'],hours:'Mon–Thu 11:30am–11pm.',url:'https://mercatto.ca/menu/dinner?location_id=3658',note:'Existing full-time bar/server vacancies. Ask for the hiring contact only if service allows.'},
         {id:'C33',walk:20,window:['14:30','16:30'],hours:'Lunch and dinner daily (hours not verified).',url:'https://snugharbour.above-the-cloud.com/careers.php',note:'Optional walk-in with a résumé; no dated vacancy.'}
       ],omitted:['C33'],later:'POSTA and La Vita remain optional scouts; neither displaces the live roles.'},
      {id:'oakville',name:'Downtown Oakville · optional',date:'2026-09-23',start:'14:15',days:[1,2,3,4],omitted:['N02','N26'],preferred:'Wednesday · only if Aidan replies or time allows',station:'Oakville GO, Oakville',
       ...
       why:'Ce Soir now has bartender and server postings, which are a real reason to be seen; Tabule is a reserve application, not a visit. Secondary to any interview.',
       stops:[
         {id:'N11',walk:0,window:['14:00','16:00'],hours:'Sun–Thu 11am–11pm; kitchen until 10pm.',url:'https://cesoirbrasserie.com/',note:'Bartender/server applications first. Ask for the FOH manager; presence during service is unconfirmed.'},
         {id:'C21',walk:35,window:['14:30','16:30'],hours:'Dinner-led; afternoon hours not verified.',url:'https://www.barsu.ca/',note:'Kerr Village; confirm opening hours before adding this leg.'},
         {id:'N02',walk:7,window:['14:00','16:00'],hours:'Mon–Thu 11:30am–10pm.',url:'https://tabule.ca/location/tabule-oakville/',note:'Reserve application only; off by default.'},
      ...
      {id:'exhibition',name:'Exhibition Place · online-first',date:'2026-09-24',start:'14:00',days:[1,2,3,4,5],omitted:['C08','C10'],preferred:'Only if an employer invites you',station:'Exhibition GO, Toronto',
