...
3. **Instructions:**
   ...
   12. Ask **Show coffee charges over $5 this month**, **What bills are due in two weeks?**, **How much did we earn this month?**, and **How are the jars doing?**. These exercise Brain v2's typed read tools. Tap every amount card and verify that transaction/category facts open the register while account facts open the wallet.
