...
- Current candidate: local `v0.0.30` on `issue-10-cad-currency`; development Apps Script remains v0.0.29 until the high-risk review and explicit development-only push gates pass
