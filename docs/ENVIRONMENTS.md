...
- Runtime status: v0.0.28 source deployment verified; live diagnostics, invalid-request count preservation, controlled valid transaction, and final Data Health Check remain pending
