...
- Current candidate: local/GitHub-only `v0.0.31` on `issue-2-add-shift-e2e`; repository tests pass, and independent review plus development-only push approval remain pending
