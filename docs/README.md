...
| [ux/computer-office/STUDIO_SETUP_CHECKLIST.md](ux/computer-office/STUDIO_SETUP_CHECKLIST.md) | Beginner tick-boxes to install the glue (PureRef, fSpy importer, ffmpeg, Comfy Manager). AIs must handhold this way whenever Jonathan operates those apps |
