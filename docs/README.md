...
| [briefs/BIANCA_MONTH_ONE_REHEARSAL_HANDOFF_2026-08-28.md](briefs/BIANCA_MONTH_ONE_REHEARSAL_HANDOFF_2026-08-28.md) | D-182 Development-only four-week rehearsal, exact golden month, mainline App/command-sync contract, Bianca playtest/friction gate, evidence, and no-launch handoff |
