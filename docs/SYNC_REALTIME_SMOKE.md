...
| G6 Trust review | ⚠️ **CONDITIONAL PASS** — auditors run 2026-08-27; P0 personal gzip fix **merged #183 + deployed** `e63c689`; P1 proof gaps before “closed” ([`worksessions/2026-08-27-g6-trust-review.md`](worksessions/2026-08-27-g6-trust-review.md)) |

**Still open before T2:** P1 automated 012 proof + harness Tier 1 path; T1-S6 freshness UI (in flight elsewhere); merge T2-S1 after rebase + Migration **013** apply.
