...
Both Taylor Home compositions require separate JONATHAN and BIANCA bracelets. Actual bracelet photos determine bead colours, lettering, spacing and charms. Bianca’s supplied dress is a private rose-pink sequin material reference. No concert ticket exists; its fictional artwork and requirement are removed. Additional concert photographs have authored placements. `src/theme/memorabilia.ts` tracks these required files. Missing photographs cannot be called complete. Originals stay outside the committed set; public derivatives have no sensitive metadata. No photo-management feature is introduced.
...
Jonathan explicitly authorised fictional placeholders pending memorabilia access. Concert illustrations remain labelled placeholders. The 2026-09-09 page refinement supersedes the ticket and dress placeholders with a bottom-of-Home album and original rose-pink sequin material. The Home mount is below the Fold/instruments and never takes a financial priority slot. Awaiting-original manifest entries stay unresolved; no invented venue/date or claim these are actual photos. Prepared public derivatives will replace samples without a management feature. This amendment supersedes the earlier real-photos-before-any-integration restriction for the current mobile task.

## Page refinement amendment — 2026-09-09

[Living page contract](PAGE_WORLD_REFINEMENT.md) is the current eight-PR implementation authority. Both Taylor Homes end with the manually browsable scrapbook, after Office and Notes. Photos await Bianca’s selection; supplied dress and Newfoundland originals remain private references. The ticket requirement is withdrawn.
