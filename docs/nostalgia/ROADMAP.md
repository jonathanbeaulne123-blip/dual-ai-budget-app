...
This **was** the living near-term plan. The investor / family-office vision essay is [PRODUCT_ROADMAP.md](PRODUCT_ROADMAP.md) in this folder. Sheets-era calendars are [../reference/sheets-era/ROADMAP.md](../reference/sheets-era/ROADMAP.md). History, not a bible.
