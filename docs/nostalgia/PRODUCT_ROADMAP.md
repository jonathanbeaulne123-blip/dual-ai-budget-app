...
This **was** the product vision. It is directional history. Jonathan still approves anything that moves money, talks to a bank, or leaves the Development snapshot. Sheets-era calendars (September 1 test build, clasp, dashboard-as-spreadsheet) live in [../reference/sheets-era/ROADMAP.md](../reference/sheets-era/ROADMAP.md). History, not a bible.
