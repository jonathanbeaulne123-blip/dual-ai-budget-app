## Hearthside full program — integration verification (2026-09-12)

Integration checkout `.codex-work/hearthside-program`, branch `codex/hearthside-program`, merges current main `a96c1ffb0905957d20c16491846ff0ca4b9b5e3c` at `2db4891c82eaf825eceeafefa1a9426457e4c20a`. Preserves #461 and subsequent Nest/King, Calendar and Hercules changes. The full user-approved P0–P15 scope remains open; use the [package register and evidence](worksessions/2026-09-12-hearthside-program.md). All planned local packages are now integrated, including canonical Nest pottery, explicit shared-life restore, actual guest service assembly, unsigned native CI and Workspace merge repairs. Root combined High gate/build remain pending this checkpoint; no whole-program completion claim.
