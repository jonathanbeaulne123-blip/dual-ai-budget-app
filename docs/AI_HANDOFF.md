...
**Verification:** focused Swipe, D-197 custody, and persisted Undo history are **24/24 passed** and TypeScript is green. The repaired candidate passed `pnpm check:windows`: AI surface; **224 fast files passed / 1 skipped with 1,547 tests passed / 2 skipped**; **18 serial books files passed / 1 skipped with 146 tests passed / 1 skipped**; **1,693 passed / 3 skipped total**; TypeScript; a **413-module** production build; Hercules Pro UI; and redirect guard. Fresh visual proof at 320/390/720/1100 showed no horizontal overflow, 44 px controls, effective background `inert`, one title/Amount label, and Escape focus return. The two P2s found by first exact-head review—lost command identity after reload and destructive-looking error colour—are repaired; final exact-head re-review, PR, post-merge CI, deployment, and live no-store/asset gates remain pending. Worksession: [`worksessions/2026-09-02-till-2-swipe-release.md`](worksessions/2026-09-02-till-2-swipe-release.md).
