...
| [2026-08-28 Gmail 7shifts review](worksessions/2026-08-28-gmail-shift-review.md) | **D-163 RELEASE APPROVED; IN PROGRESS** | Direct Gmail read-only import, reduced Hercules review, and sealed explicit shift confirmation | Rebased onto `main@7e5dc88`; no Cloudflare mail dependency; Gmail consent remains after deploy |
