...
**Household Fund life Plan — local implementation (2026-09-11):** four distinct decision journeys now use one projection for evidence, coverage and dated capacity; Hercules opens the same contextual private conversation and reviewed actions. Editable alternatives, contextual learning, resumable Sitdown and Shared Home / Our Money / Our Path / Together complete the local slice. Deployment, authenticated two-partner/provider proof, physical accessibility and product acceptance remain open. [Implementation and acceptance](briefs/HOUSEHOLD_FUND_LIFE_PLAN_IMPLEMENTATION.md) · [Worksession](worksessions/2026-09-11-fund-life-plan.md).

**Plan System V2 — Development deployed (2026-09-11):** Personal and Household planning now share versioned four-lens contracts, private drafts, exact two-person Household acknowledgement, complete reflection/Bridge editors, trusted Shared Hercules turns, durable Toronto-timed activation, PGlite/event continuity and a new twelve-combination PlanStudio. PR #433 serves the V2 presentation in Development with a manual legacy-presentation rollback; authenticated two-browser/live-provider continuity, sleeping-client alarm observation, full replay/restore acceptance, physical accessibility and product acceptance remain open. [Worksession](worksessions/2026-09-11-plan-system-rebuild.md).
...
**2026-09-14 — The Queen's world page (D-255), local patch:** Our Home behind `VITE_QUEENS_NEST` is one fixed, edge-to-edge world — the two-space tabs, her field with its quiet line and doors, the five-slot nav, nothing else. Measured on the actual App page (not the stand-in harness): she was 26 % of a 390×844 viewport with her canvas at y=603 and 290 px of page scroll; she is now 76.5 % with no scroll at 320/390/720/1100. The top bar, the sync line with its "Needs attention", the household switcher, the scene heading, the office instruments and the Fund ledge move behind her Status door or stay on every other destination; the chrome under her is measured at runtime, never reserved. Not pushed, merged, deployed or live verified. [Worksession](worksessions/2026-09-14-queen-world-page.md).

**2026-09-14 — The cellar's bill rail (D-256), local patch:** the cellar opens on this month's bills — every bill bank on its due day as a jar whose shape is its type and whose water is what its bank has saved, the Fund walk as the water behind the rail with the buffer as a tidemark, no figure on the rail. Jonathan's strike rule: the hammer only by hand, only when due and full, only for a recurring bill (the existing `postDueRecurrences` behind Final Confirm; no bank money moves); a crack when due and not full, still payable from the water; a shard when paid anywhere else in the app; nothing early. Lifting a jar out is a rehearsal that writes nothing. Not pushed, merged, deployed or live verified. [Worksession](worksessions/2026-09-14-queen-cellar.md).

**2026-09-14 — The house, merged and glassed (D-257), local patch:** the kitty banks stand in the rooms, the cellar opens on the bill rail, one vertical axis (swipe, haul, arrows, a slim rail of three marks) joins the three floors, and every chip is glass — smoked with paper text in the live cellar. Not pushed, merged, deployed or live verified. [Worksession](worksessions/2026-09-14-queen-house-merge.md).

**2026-09-14 — The Hercules habitats (D-259), local patch:** two Development-only synthetic households from the Demo Suite's generator — *doing well* and *doing badly* — with twelve fictional months told through the ordinary commands, two buttons in the Demo Suite panel, replayable from a seed and verified. Not pushed, merged, deployed or live verified. [Worksession](worksessions/2026-09-14-hercules-habitats.md).

**2026-09-14 — The Queen's creation and history (D-254), local patch:** every closed Chapter leaves a growth ring in her lathe; the couple throws her on the wheel in two handed-over turns before any money; she tips over to show the makers' marks; each closed year leaves an immutable portrait on an Our Story shelf; her light follows the household's day and season without ever animating. All on the King draft she already wears, behind `VITE_QUEENS_NEST`. Shared authorship of her form is still uncovered by the repo.

**2026-09-14 — The Queen's charms (D-253), local patch:** small ceramic add-ons the couple presses onto her wherever they choose — six from the first day, six earned by acts already recorded (a travel goal bought, a Ritual held ten times, a Chapter closed after a hard month, the Charter signed, the first Sitdown, a correction mended) — kept on the King design's draft through the same guard, refused physically on her reserved channels, instanced and capped at sixteen, drawn identically with no WebGL. Not pushed, merged, deployed or live verified. [Worksession](worksessions/2026-09-14-queen-charms.md).

**2026-09-14 — The Queen's world (D-252), local patch:** the Still Queen becomes a still 3D diorama fed by the pottery studio — one renderer, one scene, a fixed camera; she is her own sculpture with reserved channels on separate geometry, the banks are the studio's own sculptures wearing what their owners authored, fired reads fired, freshness owns her glaze axis and she is never fired. The flat path is the Still Queen as shipped and carries every reading; no WebGL degrades silently. Not pushed, merged, deployed or live verified. [Worksession](worksessions/2026-09-14-queen-world.md).

**2026-09-13 — The Still Queen (D-251), local patch:** Household Home behind `VITE_QUEENS_NEST` is rebuilt from the ground up as one figure in a field of nothing — her, one quiet line and the Move at rest; two near-invisible field doors (Together, Status) revealed by tapping the empty field; tapping her expands her into Protect · What Now · Build with a button above each; glass panels or bottom sheets peek; the cellar (ribbon) and the loft (shelf) are the rooms and she does not follow you in. Presentation only over the same shipped projections; the four nest categories and their tests are unchanged; the page never scrolls at 320/390/720/1100. Theme expressions remain a later stage. Not pushed, merged, deployed or live verified. [Worksession](worksessions/2026-09-13-still-queen.md).

**2026-09-13 — The Queen's Nest, Stage 1 (D-250), local patch:** Household Home can be composed as one body — crown, vine and buds, face, hands, body and belly, two doors, hem — over the same pulse, Chapter, nest, presence and obligation projections, behind opt-in `VITE_QUEENS_NEST=1` inside the Plan V2 family. Presentation only: the four nest categories, `allocateNestTotal`, tiers and their tests are unchanged; every region is a real keyboard control leading to an existing destination; Home does not scroll at 320×700 and above. Stage 2 (cellar/loft, ribbon, shelf), the Hercules sentence and the three theme expressions remain. Not pushed, merged, deployed or live verified. [Worksession](worksessions/2026-09-13-queens-nest-stage-1.md).

**2026-09-12 — Plan V2 deployment guard (D-248) deployed:** live Development had a valid `main@d152a97` deploy replaced ten minutes later by a separately promoted artifact whose Plan flag compiled undefined, restoring the retired Categories/Sitdown UI. PR #457 (`2d6b70fa`) makes missing build metadata keep current Plan V2/Horizon A active; only explicit `0`/`false` selects the legacy rollback. CI and Cloudflare passed, Worker `874e090a…` serves 100% traffic, and the fresh bundle contains the guarded current Plan and all four lenses. No ledger, schema, hosted row, Production setting, or money authority changed. [Worksession](worksessions/2026-09-12-plan-v2-deploy-guard.md).
...
|---|---|---|---|
| Plan System V2 | D-239 and D-241 add scope-safe monthly Plan records, private Household prework, immutable proposals/digests, complete reflection/Bridge editors, trusted Shared Hercules replies, Toronto-timed durable activation, compatibility budget projection, deterministic Plan tools and the new PlanStudio behind a reversible flag. Plan actions do not post money. | **DEVELOPMENT DEPLOYED — PR #433 / `5c90adc`:** merged-main checks pass, Worker `8ace4c5b…` is active, and the live no-store bundle contains the enabled V2 markers. Manual workflow input `0` retains the legacy presentation rollback. Production continuity remains off. | Authenticated two-browser Shared Sitdown, Hercules and acknowledgement proof; deployed sleeping-client alarm observation; event compaction/restore corpus; physical accessibility/product review; repair the pre-existing exhaustive repository gate. |
...
|---|---|---|---|
| [2026-09-05 onboarding Chapter 12 Ready and unlock](worksessions/2026-09-05-onboarding-ready-unlock.md) | **CLOSED; LOCAL HIGH-GATE + BUILD + UX VERIFIED** | D-225 isolated Practice or accepted proof, exact shared completion digest, two self-owned Ready approvals, all-gates unlock, forward repair | 30 focused tests; 438-test onboarding suite; High quick gate (120 fast + 7 serial); 477-module build; actual-component 320/390/720/1100 px accessibility pass; no money, schema, hosted data, Production, push, merge, or deploy |
| [2026-09-05 onboarding Chapter 11 first plan](worksessions/2026-09-05-onboarding-first-plan.md) | **RELEASE AUTHORIZED; LOCAL QUICK-GATE + BUILD + UX VERIFIED** | D-224 inspectable authored inputs, exact recurrence/run-rate derivation, self-owned approvals, explicit recovery-aware adoption, current receipt gate | 16 focused tests; 126-test Medium quick gate; 426-test onboarding suite; 475-module build; live 320/390/720/1100 px accessibility pass; independent no-P0-P2 review; no journal/transfer, schema, hosted data, Production, or deploy |
| [2026-09-05 explicit PGlite cloud repair](worksessions/2026-09-05-pglite-explicit-repair-cancel.md) | **ACTIVE; LOCAL RELEASE REVIEW CONDITIONAL** | D-212 exact stuck-opener retirement inside one repair lane; authenticated Shared + Personal replacement; no IndexedDB deletion | hosted revision 26 durable while Mac stayed 25; 43/43 books, Release quick gate 161/161 with soft-budget breach, build, and independent re-review green; Production off; PR CI, deploy, Mac restore, and fresh sub-one-second witness pending |
| [2026-09-05 atomic onboarding budget adoption](worksessions/2026-09-05-onboarding-adoption.md) | **CLOSED; LOCAL HIGH-GATE + BUILD VERIFIED** | D-223 current proposal plus plan-state-bound approvals, all-or-nothing plan batch, deterministic receipt retry, guarded Shared replay | 14 focused + 95 adjacent tests; High quick gate; 473-module build; independent no-P0-P3 review; no Chapter 11 UI, journal/transfer, schema, hosted data, Production, push, merge, or deploy |
| [2026-09-04 self-owned onboarding approvals](worksessions/2026-09-04-onboarding-approvals.md) | **CLOSED; LOCAL HIGH-GATE + BUILD VERIFIED** | D-222 immutable member-owned proposal/Ready approval, exact digest, two-seat authorization, Shared convergence | 14 focused tests plus adjacent onboarding/continuity proof; High quick gate; 471-module production build; independent review; no UI, plan or money write, schema, hosted data, Production, push, merge, or deploy |
| [2026-09-04 deterministic onboarding proposal](worksessions/2026-09-04-onboarding-proposal.md) | **CLOSED; LOCAL HIGH-GATE + BUILD VERIFIED** | D-221 half-up authored estimates, exact recurring floors, eligible upward run rate, reproducible SHA-256 source digest | 13 focused and 61 adjacent tests; 51-test High quick gate; 470-module production build; independent re-review found no P0-P2 blocker; no UI, money write, schema, hosted data, Production, push, merge, or deploy |
| [2026-09-04 onboarding Chapter 10 estimates](worksessions/2026-09-04-onboarding-estimates.md) | **CLOSED; LOCAL QUICK-GATE + BUILD + UX VERIFIED** | D-220 private first guesses, exact category-set binding, missing versus zero, authored non-comparative reveal | 142 focused/adjacent tests; 76-test Medium quick gate; 469-module production build; live 320/390/720/1100 px accessibility pass; no money, schema, hosted data, Production, push, merge, or deploy |
| [2026-09-04 onboarding Chapter 9 categories](worksessions/2026-09-04-onboarding-categories.md) | **CLOSED; LOCAL QUICK-GATE + BUILD + UX VERIFIED** | D-219 private choice, patient wait, deterministic reveal, reviewed category merge | 122 focused/adjacent tests; 92-test Medium quick gate; 467-module production build; live 320/390/720/1100 px accessibility pass; no money, schema, hosted data, Production, push, merge, or deploy |
| [2026-09-04 onboarding submission contract](worksessions/2026-09-04-onboarding-submissions.md) | **LOCAL COMPLETE; NOT SHIPPED** | D-218 self-attributed Shared choices, append-only revisions, deterministic convergence, zero versus missing | 53 focused/adjacent + High quick gate (67 fast + 7 serial), build, AI verifier, and independent trust review green; Windows unavailable on macOS; no UI, money, schema, hosted mutation, Production, push, merge, or deploy |
| [2026-09-04 onboarding Chapter 8 earning cadence](worksessions/2026-09-04-onboarding-cadence.md) | **CLOSED; LOCAL QUICK-GATE + BUILD + UX VERIFIED** | D-217 self-owned Shared timing, Personal detail-later boundary, honest irregular cadence | 285 focused/adjacent tests; 112-test Medium quick gate; 464-module production build; live 320/390/720/1100 px day/night accessibility pass; no amount, money, schema, hosted data, Production, push, merge, or deploy |
| [2026-09-04 onboarding Chapter 7 regular money](worksessions/2026-09-04-onboarding-recurrences.md) | **CLOSED; LOCAL QUICK-GATE + BUILD + UX VERIFIED** | D-216 valid Shared housing anchor plus one other recurrence, existing-surface standing-fact UX, no posting | 99 focused tests; 85-test Medium quick gate; 461-module production build; live 320/390/720/1100 px accessibility pass; no money, schema, hosted data, Production, push, merge, or deploy |
| [2026-09-04 onboarding Chapter 6 Household Fund](worksessions/2026-09-04-onboarding-fund.md) | **CLOSED; LOCAL QUICK-GATE + BUILD + UX VERIFIED** | D-215 same-revision two-seat Fund approval, privacy-safe evidence, replica convergence, existing-surface review | 9 focused tests; 139-test High quick gate; production build; live 320/390/720/1100 px accessibility pass; no money, schema, hosted data, Production, push, merge, or deploy |
| [2026-09-04 onboarding Chapter 5 opening truth](worksessions/2026-09-04-onboarding-opening.md) | **CLOSED; LOCAL QUICK-GATE + BUILD + UX VERIFIED** | D-213 complete Shared opening receipt, balanced equity evidence, partial/stale recovery, exact command identity | 141 focused tests; 144-test quick gate; production build; live 320/550/1100 px accessibility pass; `openingTruth.ts` unchanged; no schema, hosted data, Production, push, merge, or deploy |
| [2026-09-04 onboarding Chapter 4 accounts](worksessions/2026-09-04-onboarding-accounts.md) | **CLOSED; LOCAL QUICK-GATE + BUILD + UX VERIFIED** | D-211 Shared account/Fund-card evidence, owner-only optional Personal setup, direct editor route, privacy refusal | 180 focused tests; 208-test Medium-High quick gate; production build; live 320/390/720/1100 px accessibility pass; no bank feed, money, schema, hosted data, Production, push, merge, or deploy |
| [2026-09-04 Readiness 5 preflight repair](worksessions/2026-09-04-readiness-5-preflight-repair.md) | **LOCAL RELEASE REVIEW PASS; PR/DEPLOY/TWO-DEVICE WITNESS PENDING** | D-212 bounded local-books worker opening plus authenticated privacy-safe Development proof clock | exact clean code head `587f14c`; Release quick gate 141/141; build 459 modules; semantic Pairing UI 320/390/720/1100; no schema, hosted row, secret, provider, Production, or automatic local-books clearing |
| [2026-09-04 onboarding Chapter 3 Charter](worksessions/2026-09-04-onboarding-charter.md) | **CLOSED; LOCAL QUICK-GATE + UX VERIFIED** | D-210 current-term two-person Charter consent, existing route, evidence, patient waiting, stale self re-sign, and persistent return | 120 focused tests; Medium-High quick gate; live synthetic 320/390/720/1100 px route and accessibility pass; no schema, hosted data, money, Production, push, merge, or deploy |
| [2026-09-03 single-run pull-request CI](worksessions/2026-09-03-ci-single-pr-run.md) | **CLOSED; LOCAL QUICK-GATE VERIFIED** | D-202 scheduling de-duplication: PR quick gate plus post-merge `main` quick gate | 19/19 selected tests; Medium quick gate 21.322s; clean baseline `origin/main@f5a3cab`; no runtime, hosted data, schema, secret, Production, push, merge, or deploy |
| [2026-09-03 five-minute verification gate](worksessions/2026-09-03-five-minute-verification-gate.md) | **CLOSED; LOCAL QUICK-GATE VERIFIED** | D-202 mapped/change-focused proof by default; exact-clean-SHA owner-recorded exhaustive proof only | refreshed clean onto `origin/main@7dd1f96`; 19 policy contracts; Medium 19.722s, Medium-High 19.078s, High plus serial books canary 22.965s; no runtime, hosted data, schema, secret, Production, push, merge, or deploy |
| [2026-09-02 Till Slice 4 landing preference](worksessions/2026-09-02-till-4-preference.md) | **CLOSED; MERGED #306; DEVELOPMENT KITCHEN PUBLISHED; LIVE VERIFIED** | D-200 self-owned desk/Till default in the member Personal envelope; no UI act or startup takeover | `main@4992a0c`; CI `33698860263`; Cloudflare `33698859862`; Worker `558f1e53`; live `index-JsW2hVnK.js`; no Shared disclosure, schema, hosted data, secret, or Production |
| [2026-09-02 Till Slice 3 surface](worksessions/2026-09-02-till-3-surface.md) | **CLOSED; MERGED #304; DEVELOPMENT KITCHEN PUBLISHED; LIVE HTTP VERIFIED** | Reachable Till presentation over sealed Swipe and existing contribution motions; Shared Home stays the initial surface | `main@3002356`; Cloudflare `33689372692`; Worker `a52acc66`; live `index-Bfi0OGDI.js` / `index-N-WQUmzo.css`; D-199; no landing preference, schema, secret, or Production |
| [2026-09-02 Register slice 8 release](worksessions/2026-09-02-register-8-release.md) | **CLOSED; MERGED #299; KITCHEN PUBLISHED; LIVE HTTP VERIFIED** | Conserved Fund-provenance drawing in the Household table, direct Month Spread opener, forced-colors and semantic keyboard-path repairs | `main@347e4ff`; CI `33660752312`; Cloudflare `33660752817`; Worker `87b740c9`; live `Books-zKkvo2sl.js` / `Books-Dkup-FAr.css` / `Office-hcpC2ocS.js`; no writer, schema, hosted data, secret, or Production |
| [2026-09-02 Register slice 10 metronome](worksessions/2026-09-02-register-10-metronome.md) | **OPEN ON BRANCH; DRAFT PR** | Custodian paydays as timing ticks on the Course; contribution marks unchanged | draft #294 from `origin/main@7101dce`; no scale change, #285 stack, writer, schema, or Production |
| [2026-09-02 Clerk weekly document](worksessions/2026-09-02-clerk-weekly-document.md) | **CLOSED; MERGED #293; KITCHEN PUBLISHED; LIVE HTTP VERIFIED** | D-196 asynchronous weekly household document beside SitDownGuide; Gate A stamps; read-only other door; routes only for the unique active non-custodian | `main@97e1ae9`; CI `33597829546`; Cloudflare `33597829535`; Worker `b9b79e02`; live `Office-P5Sguoc5.js` / `Office-C3dOKSHl.css`; no schema, hosted data, secret, or Production mutation |
| [2026-09-01 Register slice 9 Ask panel](worksessions/2026-09-01-register-9-ask-panel.md) | **MERGED #292 onto main@7101dce** | Ask number, routes, and a named Confirm that moves only the exact shared monthly goal claim | desk Ask Confirm is separate from the weekly read-only other door |
| [2026-09-01 Charter Held core](worksessions/2026-09-01-charter-held-core.md) | **PR #283; RELEASE REVIEW PASS; DEVELOPMENT RELEASE AUTHORIZED; CURSOR UI HANDOFF READY** | D-193 append-only Hold/release/withdraw contribution motions; authority, PGlite, audit, and compacted replay | core `a772936` over `main@2879af2`; complete local proof 1,571 passed / 3 skipped plus AI/type/build gates green; fresh rebased GitHub/Cloudflare/live receipts pending; no UI, hosted schema/data, secret, or Production mutation |
...
| [2026-09-01 Charter page](worksessions/2026-09-01-charter-page.md) | **CLOSED; MERGED #275; KITCHEN PUBLISHED; LIVE HTTP UNVERIFIED** | Charter document + empty signature line | `main@86da91c`; D-041 `33486435990`; Worker `33ce5c14`; canonical hostname DNS `NXDOMAIN`; not Production |
| [2026-09-01 Charter founding conversation](worksessions/2026-09-01-charter-founding-flow.md) | **CLOSED; MERGED #271; KITCHEN PUBLISHED; LIVE HTTP UNVERIFIED** | Empty-house founding questions through existing Charter commands | merge `4074e657`; combined D-041 `33486435990`; canonical hostname DNS `NXDOMAIN`; not Production |
