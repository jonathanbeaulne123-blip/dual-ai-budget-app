...
|---|---|---|---|
| [2026-08-31 Month Spread](worksessions/2026-08-31-month-spread.md) | **OPEN; DRAFT PR #259** | Shared Home centre instrument (Standing / Course / Docket); F-2/F-3 Fund projection corrections isolated for books review | `cursor/month-spread-shared-home-04e5` from `origin/main@2a984fd`; `pnpm check` 1311 passed / 3 skipped; not merged, not deployed |
