**Plan System V2 — local gated implementation (2026-09-11):** Personal and Household planning now share versioned four-lens contracts, private drafts, exact two-person Household acknowledgement, complete reflection/Bridge editors, trusted Shared Hercules turns, durable Toronto-timed activation, PGlite/event continuity and a new twelve-combination PlanStudio. The flag remains off; authenticated two-browser/live-provider continuity, full replay/restore acceptance, physical accessibility and product acceptance remain release gates. [Worksession](worksessions/2026-09-11-plan-system-rebuild.md).
