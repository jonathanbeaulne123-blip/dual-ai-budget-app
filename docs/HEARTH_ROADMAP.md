...
|---|---|---|---|
| [2026-08-31 Desk plates](worksessions/2026-08-31-desk-plates.md) | **OPEN; DRAFT PR #260** | Twelve Home mosaic plates (six Shared, six Personal) over existing selectors; Spread stays the Shared default stage | `f248d44` on `cursor/desk-plates-shared-home-021f`; no merge, deploy, schema, or Production |
