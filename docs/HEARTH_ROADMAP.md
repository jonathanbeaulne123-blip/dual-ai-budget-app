...
| Shared vs Personal ledger experience | D-164/D-173: Shared is one pool plus Kitty Banks as sub-accounts; Personal Books is the household-visible + own-room floor; Home seals are posted in/out/leftover spend. Sit-down leftover stays separate. | **INTEGRATED LOCALLY; REVIEW FIXES PENDING RE-REVIEW:** `codex/kitchen-desk-integration` combines PR #244 UX with current `main`; initial books/privacy review caught and closed an Audit/export projection escape. Not pushed, merged, deployed, or live. | Adversarial Books DOM/export canaries; route-by-route privacy denial; leftover-spend ≠ leftoverProjection; Personal floor ≠ scopedHousehold; 320/390/720/~1100 proof; independent re-review plus trust/verifier before merge. |
