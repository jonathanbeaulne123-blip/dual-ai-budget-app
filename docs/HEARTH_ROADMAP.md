...
|---|---|---|---|
| [2026-09-02 Register slice 8 release](worksessions/2026-09-02-register-8-release.md) | **RELEASE CANDIDATE; DEVELOPMENT RELEASE AUTHORIZED** | Conserved Fund-provenance drawing in the Household table, direct Month Spread opener, forced-colors and scroll-name repairs | supersedes unmounted draft #285; current-main full gates, merge, deploy, and live proof in progress; no writer, schema, hosted data, secret, or Production |
