...
|---|---|---|---|
| Priority-one Shared Money program | D-174 locks the direction: partner-backed Canadian joint account, Jonathan and Bianca first, shared bills/goals plus private accounts, equal co-owner routine authority with guardrails. No banking capability ships from the decision. | **ACTIVE — SF-02 IMPLEMENTED LOCALLY, RELEASE-GATED:** migration 017, co-owner/member lifecycle, Auth device inventory/revoke, leave recovery, audit metadata, and Auth identity lock are on `codex/shared-money-program`; no schema is applied and hosted/two-browser proof remains open. D-172, D-161, and D-162 remain unchanged. | Apply 017 to disposable Development only after separate approval; pass email/replay/anon/wrong-household/revoke/two-browser/a11y smoke; then SF-03–SF-05. |
...
| Google-account cloud continuity | Development has exact-subject discovery, automatic accepted-command transport, a durable compacting outbox, multi-household switching, member-personal replicas, atomic 012, Realtime 014, and command log 013 (D-114 / D-117 / D-143 / D-147 / D-149). Two-phone Realtime met **≤500 ms p95**; 4 s poll is fallback. | **ACTIVE:** complete remaining signed-in lifecycle/negative smoke and fresh-device recovery proof; no device is the host. | Production restore/write/security packet; offline outbox convergence and recovery proof. |
...
| Shared vs Personal ledger experience | D-164/D-173: Shared is one pool plus Kitty Banks as sub-accounts; Personal Books is the household-visible + own-room floor; Home seals are posted in/out/leftover spend. Sit-down leftover stays separate. | **INTEGRATED AND VERIFIED LOCALLY:** `codex/kitchen-desk-integration` combines PR #244 UX with current `main`; books/privacy/UX/trust found no open P0–P2 and the verifier found none. Not pushed, merged, deployed, or live. | Jonathan's review and explicit push/PR authorization; release review remains separate from local integration proof. |
...
**Progress:** T1-S1…T1-S6 and T2 command-log are merged. Development Realtime two-phone smoke and G6/T1-S6 proof are recorded. **Next continuity work:** lifecycle/recovery evidence and a separately approved Production packet.
