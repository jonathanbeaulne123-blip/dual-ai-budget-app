...
| [2026-08-31 Household-card opening repair](worksessions/2026-08-31-household-card-open-fix.md) | **LOCAL REPAIR VERIFIED; RELEASE PENDING** | Exact household/member card targets, stale-target refusal, and serialized PGlite opening | 1,308 full-suite tests passed; Windows-only `bash` check host-blocked; three independent reviews passed; no hosted, schema, secret, or Production action |
