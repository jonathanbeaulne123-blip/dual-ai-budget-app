...
|---|---|---|---|
| [2026-09-01 Register slice 9 Ask panel](worksessions/2026-09-01-register-9-ask-panel.md) | **OPEN ON BRANCH; DRAFT PR** | Ask number, routes drawing, and other door on Jonathan's wide desk only | isolated from `origin/main@09be0dc`; not stacked on #285/#286; no Till, metronome, writer, schema, or Production |
