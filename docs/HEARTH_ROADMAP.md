...
|---|---|---|---|
| [2026-09-04 onboarding submission contract](worksessions/2026-09-04-onboarding-submissions.md) | **OPEN; IMPLEMENTATION AND FOCUSED PROOF IN PROGRESS** | D-218 self-attributed Shared choices, append-only revisions, deterministic convergence, zero versus missing | 8 focused + 46 adjacent tests green; exact clean-head gates and independent High-risk review pending; no UI, money, schema, hosted mutation, Production, push, merge, or deploy |
