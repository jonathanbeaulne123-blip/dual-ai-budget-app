...
| [2026-08-27 Roadmap museum and vision](worksessions/2026-08-27-roadmap-museum-vision.md) | **RELEASE APPROVED; PUBLISHING** | Current product vision, Git-timestamped project journey, Aug 17 Sheets exhibit, Aug 23 big-thinking exhibit | D-157; preserves history without making it current plan |
...
| Living vision, project journey, and roadmap museum (release approved) | Puts the full Dual Course household promise before the audit, records Git-backed Toronto milestone times to the minute, and preserves Aug 17/Aug 23 maps as separate frozen exhibits that never feed current status. | D-157; [`worksessions/2026-08-27-roadmap-museum-vision.md`](worksessions/2026-08-27-roadmap-museum-vision.md); [`ROADMAP_SITE.md`](ROADMAP_SITE.md) |
