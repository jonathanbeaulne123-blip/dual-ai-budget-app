...
|---|---|---|---|
| [2026-09-01 Charter Held core](worksessions/2026-09-01-charter-held-core.md) | **CLOSED; CORE VERIFIED; CURSOR UI HANDOFF READY** | D-193 append-only Hold/release/withdraw contribution motions; authority, PGlite, audit, and compacted replay | core `94a9f50`; exact-rebase `pnpm check` 1,565 passed / 3 skipped plus AI/type/build gates green; no UI, hosted action, push, merge, or deploy |
