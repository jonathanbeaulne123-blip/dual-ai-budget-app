...
|---|---|---|---|
| [2026-09-02 Till two-tap swipe](worksessions/2026-09-02-till-2-swipe.md) | **OPEN; DRAFT PR #295** | D-197 custodian-only `purchase-funded`; D-198 Shared Home two-tap swipe; reconstructed Slice 1 fence because sealed SHA was never pushed | branch `cursor/till-2-swipe-0c3a` over `origin/main@1c03cbe`; not merged, not kitchen-published, not live |
