...
|---|---|---|---|
| [2026-09-02 Till Slice 3 surface](worksessions/2026-09-02-till-3-surface.md) | **OPEN ON BRANCH** | Reachable Till presentation over sealed Swipe and existing contribution motions; Shared Home stays the initial surface | `cursor/till-3-surface-0c3a` from `origin/main@6f5dd56`; D-199; no landing preference, schema, secret, or Production |
