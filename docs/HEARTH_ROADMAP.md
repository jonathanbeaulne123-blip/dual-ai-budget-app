...
| [2026-08-31 Hercules provider fallback release](worksessions/2026-08-31-hercules-provider-fallback-release.md) | **CLOSED; MERGED TO MAIN; GITHUB DEPLOYED** | Ordinary synthetic chat Gemini → Groq → OpenAI → Workers AI; Worker-only Gemini/Groq secrets | D-184; main `1650910`; active `9886a685`; OpenAI paid gate off |
