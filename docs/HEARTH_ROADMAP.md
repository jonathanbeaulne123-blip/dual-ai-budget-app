...
|---|---|---|---|
| [2026-09-02 Clerk weekly document](worksessions/2026-09-02-clerk-weekly-document.md) | **LOCAL PROOF COMPLETE; DRAFT PR #293; NOT MERGED** | D-196 asynchronous weekly household document beside SitDownGuide; Gate A stamps; read-only other door; routes only for the unique active non-custodian | `c02232d` over stamp SHA `9f74cb7`; not merged, not deployed, not live; no schema, hosted data, secret, or Production mutation |
