...
- Visual review found the dropdown option was clipped at mobile width; shortened to “3 months each” beneath “History + future” after the gate. Repeating browser verification for this copy adjustment; final CI validates committed files.
