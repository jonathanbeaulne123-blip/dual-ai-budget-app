...
- `supabase/migrations/014_realtime_publication.sql` — **proposed**, not applied.
...
- Migration **014** not applied — Realtime events may not arrive until publication is added in Supabase (many projects include tables by default; verify in SQL Editor).
