...
- Player assets retain supplied colour details in one real static draw primitive each: Bianca 7,430 triangles / 138,876 bytes; Jonathan 9,168 / 158,460 bytes. Animated body parts add their own small procedural draws. Character choice is explicit and local per environment/household/member. The browser-exposed floating limb/hip join was corrected and visually rechecked.
