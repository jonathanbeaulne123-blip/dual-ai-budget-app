...
Command kernel; D-016 meanings; CAD; `America/Toronto`; splits that sum; PGlite journal; Health refuses imbalance; Hercules never posts or reads partner-personal money (D-132 allows scoped shared-member teaching); no fake fees; no pet-death hunger meter; Auth + RLS before bank / Interac / issued cards; Accounts Floor kinds; card paydown is a transfer; Audit Office is a projection; Development ≠ Production; phrase / join / Hearth Pass; Google household bridge (live suite, never posts, D-078).
